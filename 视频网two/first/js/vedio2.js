...
(function($){
    ...
    proto.createChildren = function() {
        ...
        //[data-playPause];
        //this.$playBtn1 = this.$element.find('[data-playPause]');
        this.$playBtn=$(".ddd");
    ...
    proto.play = function() {
        this.$media.play();
        this.$playBtn1.removeClass('fa-play fa-undo')
            .addClass('fa-pause');
    };
    proto.pause = function() {
        this.$media.pause();
        this.$playBtn1.removeClass('fa-pause fa-undo')
            .addClass('fa-play');
    };
